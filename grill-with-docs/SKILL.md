...
description: "Requirement alignment via iterative questioning: shared glossary, architecture decisions (ADR). Triggers: analyze approach, review plan, new feature, architecture proposal."
---
