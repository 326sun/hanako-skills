...
description: "Generate Mermaid diagrams, export PNG/SVG/PDF. Triggers: draw diagram, flowchart, sequence diagram, class diagram, ER, state machine, architecture, git graph."
---
