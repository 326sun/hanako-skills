---
name: diagnose
description: "High-discipline debugging: build feedback loop, reproduce, 3-5 falsifiable hypotheses, instrument, fix with regression test. Triggers: debug, fix bug, error, broken, failing."
---
